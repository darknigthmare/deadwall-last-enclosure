...
const publicFiles = new Set(['index.html', 'styles.css', 'settings.css', 'command.css', 'content.css', 'narrative.css', 'squads.css', 'finish.css', 'manifest.json', 'sw.js', 'src/core.js', 'src/scenarios.js', 'src/squads.js', 'src/battlefield.js', 'src/narrative.js', 'src/save.js', 'src/art.js', 'src/tactics.js', 'src/profile.js', 'src/world-content.js', 'src/game.js', 'src/ui.js', 'src/command-ui.js', 'src/content-ui.js', 'src/narrative-ui.js', 'src/scenario-ui.js', 'src/squad-ui.js', 'src/battlefield-ui.js']);
