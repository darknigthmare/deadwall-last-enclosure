...
const publicFiles = new Set(['index.html', 'styles.css', 'settings.css', 'command.css', 'manifest.json', 'sw.js', 'src/core.js', 'src/save.js', 'src/art.js', 'src/tactics.js', 'src/profile.js', 'src/game.js', 'src/ui.js', 'src/command-ui.js']);
