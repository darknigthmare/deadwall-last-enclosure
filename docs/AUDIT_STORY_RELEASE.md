...
| P2 | Le vérificateur ASAR fournit des chemins POSIX à une bibliothèque qui parcourt les séparateurs natifs Windows. | Conversion à l’entrée de la bibliothèque seulement ; manifeste portable conservé. Contrôle réel de 40 fichiers source et du manifeste embarqué réussi sur l’ASAR fabriqué. |
