...
function resolvePublicFile(root, value) {
  ...
  try {
    ...
    if (!/^\/(?:index\.html|(?:styles|settings|command|content|narrative)\.css|manifest\.json|src\/[a-z0-9_-]+\.js|assets\/(?:[a-z0-9_-]+\/)*[a-z0-9_.-]+\.(?:png|webp|jpg|jpeg|svg|ico|woff2|ogg|wav|json))$/i.test(pathname)) return null;
