const CACHE = 'deadwall-v1.0.0-r12';
const ASSETS = ['./','index.html','styles.css','settings.css','command.css','content.css','narrative.css','squads.css','finish.css','manifest.json','src/core.js','src/scenarios.js','src/squads.js','src/battlefield.js','src/narrative.js','src/save.js','src/art.js','src/tactics.js','src/profile.js','src/world-content.js','src/game.js','src/ui.js','src/command-ui.js','src/content-ui.js','src/narrative-ui.js','src/scenario-ui.js','src/squad-ui.js','src/battlefield-ui.js','assets/icon.svg','assets/icon-192.png','assets/icon-512.png','assets/deadwall-keyart-v2.webp','assets/buildings-atlas.webp','assets/props-atlas.webp','assets/survivors-atlas.webp','assets/infected-atlas.webp','assets/vfx-atlas.webp','assets/terrain-earth.webp','assets/defenses-atlas.webp','assets/infected-expansion-atlas.webp','assets/specialists-atlas.webp','assets/district-props-atlas.webp'];
